...
export const SIGNATORIES: SignatoryRecord[] = [
  ...
  ...expand("additional-protocol-i-1977", exclude(UN_MEMBERS, AP1_NON_PARTIES)),
  ...expand(
  ...
  ...expand(
    "ottawa-treaty",
    exclude(UN_MEMBERS, OTTAWA_NON_PARTIES),
    "ratified",
  ),
  ...
  ...expand(
    "rome-statute-icc",
    exclude(UN_MEMBERS, ROME_NON_PARTIES),
    "ratified",
  ),
